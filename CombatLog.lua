...
L:RegisterTranslations("enUS", function() return {
	...
	["combatlog"] = true,
    ["Plugin options"] = true,
	["Options for the combatlog plugin."] = true,
	["Activate Plugin"] = true,
	["Activates the plugin to log events."] = true,
	["Status"] = true,
	["Show the status of this plugin."] = true,
	["Save"] = true,
	["Save the logs."] = true,
	["Clear"] = true,
	["Clear the logs."] = true,
...
function BigWigsCombatLog:Status()
	...
	BigWigs:Print("BigWigsCombatLog Status: " .. status)
end
